...
contract OjeToken is ERC20, Ownable {
    ...
    address payable public teamAddress1 = 0xEaf8C5a7232FC02BcF22a3D93D04F65bd9f829Ee;
    address payable public teamAddress2 = 0x3643d9aCB9d0F47b956a5F4E33760411e51125e4; 
    address payable public teamAddress3 = 0xAc41A27cea2001eDD15CD9821166B023c78B3a1D;
    ...
    uint256 feePercentage = 14; // 14 percent total tax. Tax split: 4% marketing, 7% eth redistribution, 3% buyback
    uint256 marketingFee = 4;
    uint256 dividendsFee = 7;
    uint256 buybackFee = 3;
    
    uint256 minimumTokenBalanceForDividends = 420000 * (10**18);
    ...
    constructor() public ERC20("Momo Token", "MOMO") {
    ...
    function openTrading() external onlyOwner {
        ...
        maxPurchaseAmount = 420000000 * (10**18); //maxPurchaseAmount = 1% supply;
...
contract OjeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("Oje_Dividend_Tracker", "Oje_Dividend_Tracker") {
        minimumTokenBalanceForDividends = 420000 * (10**18); //must hold 420000+ tokens
    }
